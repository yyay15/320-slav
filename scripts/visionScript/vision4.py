...
class Vision: 
    def __init__(self):
        ...
        self.hole_parameters={"hue":[0,255],"sat":[95,255],"value":[20,40],"Height":50,"OR_MASK":False,
            ...
            for a in Contour:
                ...
                if parameters_dict["Circle"]==True:
                    ...
                    if Area>30:
                        ...
                        RangeRBC=np.vstack((ZDistance,-Bearing)).T#Put Bearing and ZDistance into one array and arrange
                        #columnwise
